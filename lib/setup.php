...
function setup() {
  ...
  register_nav_menus([
    'primary_navigation' => __('Primary Navigation', 'squarely')
  ]);
...
function widgets_init() {
  register_sidebar([
    ...
    'id'            => 'sidebar-primary',
    'before_widget' => '<div class="m-b-lg card bg-default widget %1$s %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<div class="card-block"><h3 class="m-t-0 m-b-0">',
    'after_title'   => '</h3></div>'
  ]);
  ...
  register_sidebar([
    ...
    'id'            => 'sidebar-footer',
    'before_widget' => '<div class="m-b-lg card widget %1$s %2$s"><div class="card-block">',
